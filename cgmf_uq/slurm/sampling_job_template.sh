...
#----------------------------------------------------
CONFIG_JSON=$(awk -F',' -v id="$SLURM_ARRAY_TASK_ID" '$1==id {print $3}' "$MANIFEST")
SAMPLE_ID=$(awk -F',' -v id="$SLURM_ARRAY_TASK_ID" '$1==id {print $2}' "$MANIFEST")
...
echo "=========================================="
echo "CGMF Sampling Run"
echo "Task ID:    ${SLURM_ARRAY_TASK_ID}"
echo "Sample ID:  ${SAMPLE_ID}"
echo "Config:     ${CONFIG_JSON}"
echo "=========================================="
#====================================================
# CGMF Sampling Study - Array Job
# Generated: {{TIMESTAMP}}
#====================================================
...
SAMPLE_INFO=$(awk -F',' -v task="$SLURM_ARRAY_TASK_ID" '$1==task {print $2}' "$MANIFEST")
